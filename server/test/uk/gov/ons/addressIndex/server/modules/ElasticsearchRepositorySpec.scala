...
//      .analysis(testAnalysis)
  ...
  "Elastic repository" should {
    ...
    "return prefix filter for 'R' when passed filter 'residential' " in {
      ...
      val expected = Json.parse(
        s"""
             {"query":{"bool":{"must":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}},{"match":{"paf.pafAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}}]}}],"should":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}},{"match":{"paf.pafAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}}]}}],"filter":[{"bool":{"should":[{"prefix":{"classificationCode":{"value":"RD"}}},{"prefix":{"classificationCode":{"value":"RH"}}},{"prefix":{"classificationCode":{"value":"RI"}}}],"minimum_should_match":"1"}}],"boost":0.5}},"from":0,"size":1,"sort":[{"_score":{"order":"desc"}},{"uprn":{"order":"asc"}}],"track_scores":true}
        """.stripMargin)
    ...
    "return prefix filter for 'C' when passed filter 'commercial' " in {
      ...
      val expected = Json.parse(
        s"""
           {"query":{"bool":{"must":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}},{"match":{"paf.pafAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}}]}}],"should":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}},{"match":{"paf.pafAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}}]}}],"filter":[{"prefix":{"classificationCode":{"value":"C"}}}],"boost":0.5}},"from":0,"size":1,"sort":[{"_score":{"order":"desc"}},{"uprn":{"order":"asc"}}],"track_scores":true}
        """.stripMargin)
    ...
    "return term filter for 'RD06' when passed filter 'RD06' " in {
      ...
      val expected = Json.parse(
        s"""
           {"query":{"bool":{"must":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}},{"match":{"paf.pafAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}}]}}],"should":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}},{"match":{"paf.pafAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}}]}}],"filter":[{"terms":{"classificationCode":["RD06"]}}],"boost":0.5}},"from":0,"size":1,"sort":[{"_score":{"order":"desc"}},{"uprn":{"order":"asc"}}],"track_scores":true}
        """.stripMargin)
    ...
    "return terms filter for 'RD06,RD' when passed filter 'RD06,RD' " in {
      ...
      val expected = Json.parse(
        s"""
          {"query":{"bool":{"must":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}},{"match":{"paf.pafAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}}]}}],"should":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}},{"match":{"paf.pafAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}}]}}],"filter":[{"terms":{"classificationCode":["RD06","RD"]}}],"boost":0.5}},"from":0,"size":1,"sort":[{"_score":{"order":"desc"}},{"uprn":{"order":"asc"}}],"track_scores":true}
        """.stripMargin)
    ...
    "return error for terms filter for 'RD*,RD02' when passed filter 'RD*,RD02' " in {
      ...
      val expected = Json.parse(
        s"""
           {"query":{"bool":{"must":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}},{"match":{"paf.pafAll":{"query":"","analyzer":"welsh_split_synonyms_analyzer","boost":1,"minimum_should_match":"-40%"}}}]}}],"should":[{"dis_max":{"tie_breaker":0,"queries":[{"match":{"lpi.nagAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}},{"match":{"paf.pafAll.bigram":{"query":"","boost":0.4,"fuzziness":"0"}}}]}}],"filter":[{"terms":{"classificationCode":["RD*","RD02"]}}],"boost":0.5}},"from":0,"size":1,"sort":[{"_score":{"order":"desc"}},{"uprn":{"order":"asc"}}],"track_scores":true}
        """.stripMargin)
