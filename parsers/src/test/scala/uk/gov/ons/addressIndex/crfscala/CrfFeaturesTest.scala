...
class CrfFeaturesTest extends FlatSpec with Matchers {
  ...
  it should "return the expected amount of `Item`s for input `arbitrary` (Boolean)" in {
    val input = "arbitrary"
  ...
  it should "return the expected amount of `Item`s for input `arbitrary` (Int)" in {
    val input = "arbitrary"
  ...
  it should "return the expected amount of `Item`s for input `arbitrary` (Double)" in {
    val input = "arbitrary"
  ...
  it should "return the expected amount of `Item`s for input `arbitrary` (String)" in {
    val input = "arbitrary"
