...
/**
  ...
  */
case class AddressBySearchResponseConcise(
  tokens: Map[String, String],
  addresses: Seq[AddressResponseAddressConcise],
  filter: String,
  historical: Boolean,
  rangekm: String,
  latitude: String,
...
object AddressBySearchResponseConcise {
  implicit lazy val addressBySearchResponseConciseFormat: Format[AddressBySearchResponseConcise] = Json.format[AddressBySearchResponseConcise]
}
