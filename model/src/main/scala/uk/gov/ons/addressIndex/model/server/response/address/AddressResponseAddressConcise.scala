...
/**
  ...
  *
  */
case class AddressResponseAddressConcise(
  uprn: String,
  parentUprn: String,
...
object AddressResponseAddressConcise {
  implicit lazy val addressResponseAddressConciseFormat: Format[AddressResponseAddressConcise] = Json.format[AddressResponseAddressConcise]
  ...
  /**
    ...
    * @return
    */
  def fromHybridAddress(other: HybridAddress, verbose: Boolean): AddressResponseAddressConcise = {
