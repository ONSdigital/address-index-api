...
home.postcodehead=Find an address by postcode
home.postcodebody=Search for a single address by postcode
...
navbar.postcode=Postcode Search
...
postcode.title=Postcode demo - find an address by postcode
postcode.sfatext=Search by Postcode
postcode.found=addresses found
postcode.foundpre=We've matched
postcode.foundpost=addresses
postcode.pleasesupply=Please enter a postcode
postcode.openmap=Location map
postcodesearchform.labelsearch=Enter address
singlesearchform.placeholder=E.g. 16 James Street Swindon SN1 3HE
postcodesearchform.placeholder=For example, EX2 6GA
