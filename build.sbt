...
publishTo in ThisBuild := Some("Artifactory Realm" at "http://artifactory-sdc.onsdigital.uk:8081/artifactory/libs-release-local")
credentials in ThisBuild += Credentials("Artifactory Realm", "http://artifactory-sdc.onsdigital.uk", "build", "build")
